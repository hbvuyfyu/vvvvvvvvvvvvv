...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupObservers() {
        ...
        viewModel.isServiceRunning.observe(this) { running ->
            binding.btnStartStop.text = if (running)
                getString(R.string.stop_vcam)
            else
                getString(R.string.start_vcam)
        ...
        viewModel.rootStatus.observe(this) { hasRoot ->
            ...
            val color = if (hasRoot)
                ContextCompat.getColor(this, R.color.color_root_ok)
            else
                ContextCompat.getColor(this, R.color.color_root_fail)
    ...
    private fun setupClickListeners() {
        ...
        binding.btnStartStop.setOnClickListener {
            val isRunning = viewModel.isServiceRunning.value == true
            if (isRunning) {
                stopVCamService()
            } else {
                startVCamService()
    ...
    private fun startVCamService() {
        val mediaUri = viewModel.mediaUri.value
    ...
    private fun updateStartButton() {
        val hasMedia = viewModel.mediaUri.value != null
        binding.btnStartStop.isEnabled = hasMedia
    }
